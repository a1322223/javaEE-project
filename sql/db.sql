...
alter table db_a.address
  add constraint address_fk_user foreign key (userId) references db_a.user (id);
...
create table db_a.cart (
  ...
  updateTime datetime comment 'update time',
  userId     int      not null
  comment 'user id NN FK'
)
  comment 'cart table';

alter table db_a.cart
  add constraint cart._fk_product foreign key (productId) references db_a.product (id);
alter table db_a.cart
  add constraint cart._fk_user foreign key (userId) references db_a.user (id);
